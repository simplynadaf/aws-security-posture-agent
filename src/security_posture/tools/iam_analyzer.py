                ...
                for policy in attached["AttachedPolicies"]:
                    ...
                    if "AdministratorAccess" in policy_arn:
                        findings.append({
                            ...
                            "severity": "CRITICAL",
                            "detail": f"Role \x27{role_name}\x27 has full admin access. This violates least-privilege principle.",
                    ...
                    if "PowerUserAccess" in policy_arn:
                        findings.append({
                            ...
                            "severity": "HIGH",
                            "detail": f"Role \x27{role_name}\x27 has PowerUserAccess. Nearly as dangerous as full admin.",
                            "current": f"Attached: {policy_arn}",
                            "expected": "Scoped policies with minimum required permissions",
                        })
            ...
            try:
                ...
                if not mfa_devices["MFADevices"]:
                    findings.append({
                        ...
                        "severity": "CRITICAL",
                        "detail": f"User \x27{username}\x27 has no MFA. Account compromise via stolen credentials is trivial without MFA.",
                ...
                for key in keys["AccessKeyMetadata"]:
                    ...
                    if age_days > 90:
                        findings.append({
                            ...
                            "severity": "MEDIUM",
                            "detail": f"User \x27{username}\x27 access key \x27{key[\x27AccessKeyId\x27]}\x27 is {age_days} days old. Keys should be rotated every 90 days.",
